...
```json
[
  {"name": "myproject", "url": "https://github.com/michaelvgonzaga/myproject", "isForeman": true, "isLocal": true}
]
```
...
{
  "project": "myproject",
  "path": "/Users/user/4orman/myproject",
  "ready": true,
  "captured": [
    { "label": "spec.md present", "source": "/Users/user/4orman/myproject/spec.md" },
    { "label": "CLAUDE.md decision log: 8 rows", "source": "/Users/user/4orman/myproject/CLAUDE.md" }
  ],
  "unextracted": [],
  "warnings": []
}
...
```json
{
  ...
  "version": "v1.3.0",
  "format": "fmz",
  "output_path": "/Users/user/myproject-v1.3.0.fmz",
  "success": true,
  "note": "import on any machine: 4orman-tools import myproject-v1.3.0.fmz"
}
```
...
{
  "name": "myproject",
  "dest_path": "/Users/user/4orman/myproject",
  "source_format": "fmz",
  "deps_note": "run `4orman-tools knowledge-audit` to verify knowledge extraction",
  "success": true,
  "note": "imported → /Users/user/4orman/myproject"
}
```
