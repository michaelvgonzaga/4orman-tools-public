...
```json
{
  "path": "/path/to/4orman/src/main.zig",
  "lines": 840,
  "bytes": 28500
}
```
...
```json
[
  {"name": "my-project", "url": "https://github.com/exampleuser/my-project", "isForeman": true, "isLocal": true}
]
```
...
{
  "project": "my-project",
  "path": "/path/to/4orman/my-project",
  "ready": true,
  "captured": [
    { "label": "spec.md present", "source": "/path/to/4orman/my-project/spec.md" },
    { "label": "CLAUDE.md decision log: 8 rows", "source": "/path/to/4orman/my-project/CLAUDE.md" }
  ],
  "unextracted": [],
  "warnings": []
}
...
```json
{
  ...
  "version": "v1.3.0",
  "format": "fmz",
  "output_path": "/path/to/my-project-v1.3.0.fmz",
  "success": true,
  "note": "import on any machine: 4orman-tools import my-project-v1.3.0.fmz"
}
```
...
{
  "name": "my-project",
  "dest_path": "/path/to/4orman/my-project",
  "source_format": "fmz",
  "deps_note": "run `4orman-tools knowledge-audit` to verify knowledge extraction",
  "success": true,
  "note": "imported → /path/to/4orman/my-project"
}
```
