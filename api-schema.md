...
```json
[
  {"name": "my-project", "url": "https://github.com/user/my-project", "isForeman": true, "isLocal": true}
]
```
...
{
  "project": "my-project",
  "path": "/Users/user/4orman/my-project",
  "ready": true,
  "captured": [
    { "label": "spec.md present", "source": "/Users/user/4orman/my-project/spec.md" },
    { "label": "CLAUDE.md decision log: 8 rows", "source": "/Users/user/4orman/my-project/CLAUDE.md" }
  ],
  "unextracted": [],
  "warnings": []
}
...
```json
{
  ...
  "version": "v1.3.0",
  "format": "fmz",
  "output_path": "/Users/user/my-project-v1.3.0.fmz",
  "success": true,
...
{
  "name": "my-project",
  "dest_path": "/Users/user/4orman/my-project",
  "source_format": "fmz",
  "deps_note": "run `4orman-tools knowledge-audit` to verify knowledge extraction",
  "success": true,
  "note": "imported → /Users/user/4orman/my-project"
}
```
