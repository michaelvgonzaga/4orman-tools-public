...
```json
[
  {"name": "my-app", "url": "https://github.com/example/my-app", "isForeman": true, "isLocal": true}
]
```
...
{
  "project": "my-app",
  "path": "/Users/me/4orman/my-app",
  "ready": true,
  "captured": [
    { "label": "spec.md present", "source": "/Users/me/4orman/my-app/spec.md" },
    { "label": "CLAUDE.md decision log: 5 rows", "source": "/Users/me/4orman/my-app/CLAUDE.md" }
  ],
  "unextracted": [],
  "warnings": []
}
...
```json
{
  ...
  "version": "v1.3.0",
  "format": "fmz",
  "output_path": "/Users/me/my-app-v1.3.0.fmz",
  "success": true,
  "note": "import on any machine: 4orman-tools import my-app-v1.3.0.fmz"
}
```
